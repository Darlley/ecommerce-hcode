...
<head>
    ...
    <link rel="stylesheet" href="app/admin/bootstrap/css/bootstrap.min.css"> <!-- Bootstrap 3.3.6 -->
    ...
    <link rel="stylesheet" href="app/admin/dist/css/AdminLTE.min.css"> <!-- Theme style -->
    <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect.
    -->
    <link rel="stylesheet" href="app/admin/dist/css/skins/skin-blue.min.css">
